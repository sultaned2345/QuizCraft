...
export const ChatInterface = forwardRef<ChatInterfaceHandle, ChatInterfaceProps>(
  (
    ...
    // --- 3. WRAP sendMessage IN useCallback ---
    const sendMessage = useCallback(
      async (messageText: string) => {
        ...
        // Use functional update for setMessages to get latest state
        ...
        try {
          const response = await fetch('/api/chat', {
            ...
            body: JSON.stringify({
              history: messages, // `messages` is a dependency of useCallback
              message: messageText,
              context: context, // `context` is a dependency of useCallback
            }),
          });
    ...
    // --- 4. EXPOSE THE FUNCTION VIA THE REF ---
    useImperativeHandle(
      ref,
      () => ({
        sendMessage,
