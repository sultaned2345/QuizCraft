...
import {
  ...
  User,
  Briefcase,
  XCircle, // Added for the pricing table
} from "lucide-react";
        ...
        <section className="py-24 bg-muted/30" id="pricing">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {/* Free Plan */}
              <Card className="border-muted shadow-sm hover:shadow-md transition-shadow bg-background">
                <CardHeader>
              ...
              {/* Pro Plan */}
              <Card className="border-primary shadow-xl scale-[1.02] relative bg-background">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-base text-muted-foreground leading-relaxed">
                  Yes! We offer a Starter plan that includes core features. For power users who need unlimited uploads and advanced features like Audio Notes and Essay Grading, we recommend the Pro plan.
                </AccordionContent>
              </AccordionItem>
