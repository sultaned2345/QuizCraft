        ...
        <section className="py-24 bg-muted/30 backdrop-blur-sm">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              {/* REFINED TITLE: Lowercase 'excel' as requested */}
              <h2 className="text-3xl md:text-5xl font-bold mb-4">Everything you need to <span className={AURORA_TEXT_CLASS}>excel</span></h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Power up your study sessions with tools designed to help you understand faster and retain more.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              <FeatureCard
                ...
                description="Don't just read—converse. Upload PDFs or docs and ask questions to get instant, cited answers found directly within your study materials."
              />
              <FeatureCard
                icon={<FileQuestion className="w-6 h-6" />}
                title="AI-Powered Quizzes"
                description="Test your knowledge instantly. Generate challenging multiple-choice, true/false, and fill-in-the-blank quizzes from any text or note in seconds."
              />
              <FeatureCard
                icon={<Layers className="w-6 h-6" />}
                title="Spaced Repetition Cards"
                description="Memorize facts for the long term. Convert raw notes into smart flashcard decks that schedule reviews at the perfect time for retention."
              />
              <FeatureCard
                icon={<FileText className="w-6 h-6" />}
                title="Intelligent Summaries"
                description="Cut through the noise. Paste complex text, URLs, or articles to get concise, structured notes that highlight only the key concepts you need."
              />
              <FeatureCard
                icon={<PenTool className="w-6 h-6" />}
                title="Real-Time Essay Feedback"
                description="Write with confidence. Get instant scoring on clarity, argumentation, and grammar, complete with highlighted actionable advice to improve your grade."
              />
              <FeatureCard
                icon={<FolderKanban className="w-6 h-6" />}
                title="Seamless Organization"
                description="Keep your academic life sorted. Group related documents, quizzes, and decks into dedicated Projects so you can switch between subjects instantly."
              />
            </div>
          </div>
        </section>
