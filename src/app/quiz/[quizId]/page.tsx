...
import { NoteEditor } from "@/components/NoteEditor"; // Ensure this import exists
...
export default function StudyWorkspacePage({ params }: PageProps) {
  ...
  // --- HOOK INTEGRATION ---
  // We pass a callback to refresh data after generation
  ...
  }, [documentId, invalidId, refreshData]);
